...
public class ObjCParser extends Parser {
	...
	public static final int
		...
		IMPORT=132, INCLUDE=133, PRAGMA=134, ERROR=135, WARNING=136, WS=137, COMMENT=138, 
		LINE_COMMENT=139, HDEFINE=140, HIF=141, HELSE=142, HUNDEF=143, HIFNDEF=144, 
		HENDIF=145;
	public static final String[] tokenNames = {
		...
		"ERROR", "WARNING", "WS", "COMMENT", "LINE_COMMENT", "HDEFINE", "HIF", 
		"HELSE", "HUNDEF", "HIFNDEF", "HENDIF"
	};
	public static final int
		RULE_lex = 0, RULE_external_declaration = 1, RULE_preprocessor_declaration = 2, 
	...
	public static final String[] ruleNames = {
		"lex", "external_declaration", "preprocessor_declaration", "class_interface", 
	...
	public static class LexContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ObjCListener ) ((ObjCListener)listener).enterLex(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ObjCListener ) ((ObjCListener)listener).exitLex(this);
		}
	}
