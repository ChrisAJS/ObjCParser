...
public interface ObjCListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link ObjCParser#lex}.
	 * @param ctx the parse tree
	 */
	void enterLex(@NotNull ObjCParser.LexContext ctx);
	/**
	 * Exit a parse tree produced by {@link ObjCParser#lex}.
	 * @param ctx the parse tree
	 */
	void exitLex(@NotNull ObjCParser.LexContext ctx);
	/**
